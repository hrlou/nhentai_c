...
namespace nhentai {
    ...
    class Tag {
        ...
        public:
            ...
            const unsigned int id(void) const { return m_Id; }
            const std::string name(void) const { return m_Name; }
            const std::string url(void) const { return m_Url; }
            const std::string type_str(void) const { return type_to_str(m_Type); }
            const TagType type(void) const { return m_Type; }

            inline void print(std::ostream& out) const {
                out << type_str() << ": " << m_Id << ", " << m_Name << "; " << m_Url;
            }
    ...
    class Doujin {
        private:
            ...
            std::string m_Fmt = DEFAULT_NAMING;
            std::string m_WorkingDir = DEFAULT_WORK_DIR;
            ...
            inline std::string page_url(unsigned int page, char ext) const {
...
namespace nhentai {
    void put_tag_of_type(std::ostream& out, const Doujin* doujin, TagType type);
}
